...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"ejercicios/abort-fetch.js":[function(require,module,exports) {
const url = 'https://images.pexels.com/photos/974470/nature-stars-milky-way-galaxy-974470.jpeg?q=100'; // Elementos del DOM imagen y 2 botones

const img = document.getElementById('huge-image');
const loadButton = document.getElementById('load');
const stopButton = document.getElementById('stop');
let controller; // Función que habilita o desabilita un boton

function startLoading() {
  loadButton.disabled = true; // Camnbia el texto de su contenido
...
loadButton.onclick = async function () {
  ...
  startLoading(); // Declaramos la variable antes para despues tener acceso a ella
  ...
  try {
    ...
    const blob = await response.blob(); // Convertimos el blob binario a una URL, el navegador se encarga de asignar el blob una url

    const imgUrl = URL.createObjectURL(blob); // Ahora el src se lo asignamos a la url de la imagen
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ejercicios/abort-fetch.js"], null)
//# sourceMappingURL=/abort-fetch.7076eeb2.js.map